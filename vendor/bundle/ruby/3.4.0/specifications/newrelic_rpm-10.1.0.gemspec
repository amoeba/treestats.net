# -*- encoding: utf-8 -*-
# stub: newrelic_rpm 10.1.0 ruby lib

Gem::Specification.new do |s|
  s.name = "newrelic_rpm".freeze
  s.version = "10.1.0".freeze
  ...
  s.executables = ["newrelic_rpm".freeze, "nrdebug".freeze]
  s.extra_rdoc_files = ["CHANGELOG.md".freeze, "CONTRIBUTING.md".freeze, "LICENSE".freeze, "README.md".freeze, "newrelic.yml".freeze]
  s.files = ["CHANGELOG.md".freeze, "CONTRIBUTING.md".freeze, "LICENSE".freeze, "README.md".freeze, "bin/newrelic_rpm".freeze, "bin/nrdebug".freeze, "newrelic.yml".freeze]
  ...
  s.add_development_dependency(%q<rubocop>.freeze, ["= 1.81.7".freeze])
  s.add_development_dependency(%q<rubocop-ast>.freeze, ["= 1.47.1".freeze])
  s.add_development_dependency(%q<rubocop-minitest>.freeze, ["= 0.38.2".freeze])
  s.add_development_dependency(%q<rubocop-performance>.freeze, ["= 1.26.1".freeze])
