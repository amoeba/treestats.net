@servers = [{name: "ACPrime",
  ...
  {name: "IsparAC",
   description: "RETAIL / ACE / UCM OK / 3 MAX CONCURRENT SESSIONS PER IP ",
   type: "PvE",
   software: "ACE",
   host: "ispar.net",
   port: "9000",
   website_url: "",
   discord_url: "https://discord.gg/X8YUAPftXQ"},
  {name: "Jellocull",
  ...
  {name: "Podtide",
   ...
   type: "PvP",
   software: "ACE",
   host: "podtide.ddns.net",
   port: "9000",
   website_url: "http://podtide.com/",
   discord_url: "https://discord.gg/MQEfzwTddG"},
  {name: "Reefcull",
