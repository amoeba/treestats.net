module ServerHelper
  ...
  @servers = [{name: "ACPrime",
    ...
    {name: "DarkSide-PK",
     ...
     discord_url: "WIP"},
    {name: "Dekarutide",
     description: "ACE-Classic Dark Majesty era custom PVE server with a Perma PK option, with new skills, techniques, tactics, endless hybrid template possibilities. Quest item mutations for unlimited replayability!",
     type: "PvE",
     software: "ACE",
     host: "147.135.30.224",
     port: "9000",
