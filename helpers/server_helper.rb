module ServerHelper
 ...
 {:name=>"HARVESTreGAINed",
  :description=>
   "End of retail with the popular opensource content like BeyondAC and New Roulea island and more added. Custom starting town and some quality of life changes. New accounts get a 1mill xp gem and some trade notes to start with. No account limits. 2000 player limit. Beefy Server Hardware. Active admin team. Looking for more players and recruiting staff. Website and discord under construction. See you in game.",
  :type=>"PvE",
  :software=>"ACE",
  :host=>"harvestregained.claynet.xyz",
  :port=>"9000",
  :website_url=>"https://harvestregained.claynet.xyz",
  :discord_url=>"https://discord.gg/kcNv8QUN"},
 {:name=>"Harvestbud",
  ...
  :discord_url=>"https://discord.gg/jd3dEJf"},
 {:name=>"Harvestgain_Originals",
  :description=>"Old school original Harvestgain players!",
  :type=>"ACE",
  :software=>"PVE",
  :host=>"206.206.165.175",
  :port=>"9000",
  :discord_url=>"https://discord.gg/Gh9ugXHQFH"},
 {:name=>"Hightide",
