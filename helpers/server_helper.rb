module ServerHelper
  ...
  @servers = [{name: "ACPrime",
    ...
    {name: "DarkSide-PK",
     ...
     discord_url: "WIP"},
    {name: "Dekarutide",
     description: "ACE-Classic Dark Majesty era custom PVE server with Hardcore PVE and Hardcore PK option, with new skills, techniques, tactics, endless hybrid template possibilities!",
     type: "PvE",
     software: "ACE",
     host: "147.135.30.224",
     port: "9000",
    ...
    {name: "Fathomless Refuge",
     description: "Weekly Quest System, Permanent XP/Lum Bonus for questing, Unlimited Levels and Attributes, Magic only obtained via questing, Quest Reward updates, Offline XP Gains",
     type: "PvE",
     software: "ACE",
     host: "23.254.209.233",
     port: "9000",
    ...
    {name: "ValHeel",
     description: "A Post End-of-Retail expansion to the Asheron's Call we know and love! Hours of new questlines and content to explore. Customer mechanics not found on any other server! Start your journey in ValHeel today!",
     type: "PvE",
     software: "ACE",
