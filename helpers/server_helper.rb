module ServerHelper
 ...
 {:name=>"HARVESTreGAINed",
  :description=>
   "End of retail with custom starting area (BeyondAC), a New Roulea island, and some QOL fixes. New accounts get a 1mill xp gem and some trade notes to start with. Unlimited accounts. Active admin team. Currently 2X XP!!",
  :type=>"PvE",
  :software=>"ACE",
  :host=>"harvestregained.claynet.xyz",
  :port=>"9000",
  :website_url=>"https://harvestregained.claynet.xyz",
  :discord_url=>"https://discord.gg/aqNnHTqftH"},
 {:name=>"Harvestbud",
