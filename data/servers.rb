...
SERVERS = [{name: "ACPrime",
 ...
 {name: "Conquest",
  description: "Custom PvE server with live events, deep crafting, active development, and PK system.",
  type: "PvE",
  software: "ACE",
  host: "ACConquest.ddns.net",
  port: "9000",
  website_url: "https://dsc.gg/conquerac",
  discord_url: "https://discord.gg/Gsadhhv72S"},
 {name: "Dekarutide",
  description:
 ...
 {name: "Eversong",
  description:
   "Five difficulty worlds, quest bonuses, enlightenment & milestones, banking & lockboxes, invasions, optional classes.",
  type: "PvE",
  software: "ACE",
  host: "eversong.abrdns.com",
  port: "9000",
  discord_url: "https://discord.gg/9eHxTb7p2J"},
 {name: "Frostcull",
 ...
 {name: "Harvestagain",
  description: "A PVE Server. End of Retail. QoL Additions and some Content.",
  type: "PvE",
  software: "ACE",
  host: "harvestagain.ddns.net",
  port: "9000",
  website_url: "https://harvestagain.net/",
 ...
 {name: "InfiniteLeaftide",
  ...
  type: "PvE",
  software: "ACE",
  host: "game.infiniteleaftide.online",
  port: "9000",
 ...
 {name: "Mistwood",
  description:
   "Balanced for Solo/Small groups. Level Cap, XP, and Luminance increased. Enhanced loot. Convenience NPCs in Marketplace.",
  type: "PvE",
  software: "ACE",
  host: "mistwood.ddns.net",
  port: "9000",
  discord_url: "https://discord.gg/UMjW7qckpb"},
 {name: "Modclaim",
  description:
 ...
 {name: "MorningStorm",
  ...
  port: "9070"},
 {name: "Newfoundland",
  description: "New Feb 2026. End of retail server. All Weclome (Free buffbot Yaraq)",
  type: "PvE",
  software: "ACE",
  host: "rftc.duckdns.org",
  port: "9000",
  discord_url: "https://discord.gg/A5AHWZFUAa"},
 {name: "Nexus",
  description: "PvP/PvE hybrid server. Custom content, balanced combat,very active development.",
  type: "PvP",
  software: "ACE",
  host: "135.148.136.179",
  port: "9000",
  website_url: "https://www.nexusserver.wiki/",
  discord_url: "https://discord.gg/npZw7j6T"},
 {name: "NoESCapeGames",
  description: "RetailLike with Modded NPCs to get you where you was on your last server.",
  type: "PvE",
  software: "ACE",
  host: "noescapegames.com",
  port: "9000",
  website_url: "http://noescapegames.com",
  discord_url: "https://discord.gg/46C8afEVs4"},
 {name: "PortalStorm",
  description:
   "15 Tiers, 10 Enlightenments, Infinite Lum Augs, Optional Hard Mode, Custom Skills, Years of custom content.",
  type: "PvE",
  software: "ACE",
  host: "ac.portalstorm.us.com",
  port: "9020",
  discord_url: "https://discord.gg/YeX6mupcf"},
 {name: "Reefcull",
  ...
  port: "9000",
  discord_url: "https://discord.gg/3ngsm6e"},
 {name: "Seedsow",
 ...
 {name: "Shadowgain",
  description:
   "Usage-based progression: skills and attributes rise only through use, effectively unlimited but very slow to master.",
  type: "PvE",
  software: "ACE",
  host: "shadowgain.com",
  port: "9000",
  website_url: "https://shadowgain.com",
  discord_url: "https://discord.gg/BmFZs6N97J"},
 {name: "Shadowland",
